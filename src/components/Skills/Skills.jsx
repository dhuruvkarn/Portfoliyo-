  ...
  return (
    <div className={style.skillsbody}>
      ...
      <div className={style.allicons}>
        ...
        <div>
          <img src="/skills/Vite.jpeg" alt="html" />
          <div style={{ fontWeight: "300" }}>Vite</div>
        </div>
        <div>
          <img src="/skills/Tailwind.png" alt="html" />
          <div style={{ fontWeight: "300" }}>TailWind CSS</div>
        </div>
        <div>
        ...
        <div>
          <img src="/skills/BaseWeb.svg" alt="html" />
          <div style={{ fontWeight: "300" }}>BaseWeb UI</div>
        </div>
        <div>
          <img src="/skills/MUI.png" alt="html" />
          <div style={{ fontWeight: "300" }}>Material UI</div>
        </div>
        <div>
          <img src="/skills/git.png" alt="html" />
          <div style={{ fontWeight: "300" }}>Git</div>
        </div>
        <div>
          <img src="/skills/figma.png" alt="html" />
          <div style={{ fontWeight: "300" }}>Figma</div>
        </div>
      </div>
    </div>
  );
