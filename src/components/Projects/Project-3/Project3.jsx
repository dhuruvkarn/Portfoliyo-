    ...
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>
          ...
          provider.It is a convenient and a quick way of getting on demand
          drivers for consumers and businesses. And also provide the Car wash or
          all other Car Related Services like Fastag Recharge , RoadSide
          Assisstance .
        </p>

        <h3 style={{ color: "#B37D4E" }}>Tech stack:</h3>
        <p>
          ReactJs | Css | JavaScript | Redux | BaseWeb UI | RazorPay | React
          Hooks{" "}
        </p>
        ...
        <div className={style.btndivv}>
          {/* <button className={style.btnpro} style={{ backgroundColor: "black" }}>
            <a
              ...
              target="_blank"
              href="https://github.com/ashish-shaw/upGrad-clone-backend"
            >
              <span>
                <svg
                  style={{
          ...
          {/* <button className={style.btnpro} style={{ backgroundColor: "red" }}>
            <a
              ...
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
              href="https://drive.google.com/file/d/1Nkkn2FiDf0yCXQWS-18ryVgXxHtbLLZu/view?usp=sharing"
            >
              <span>
                <img
                  src={youtube}
