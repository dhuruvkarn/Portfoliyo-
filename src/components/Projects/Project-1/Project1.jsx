  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>
          DriveU Car Wash is a service newly introduced which is literally going
          to change the way people think about car cleaning.It is a unique
          mechanised car cleaning concept where cars are getting pampered by the
          latest equipments including high pressure cleaning machines.
        </p>

        <h3 style={{ color: "#B37D4E" }}>Tech stack:</h3>
        <p>ReactJs | TailWind CSS | JAVASCRIPT | Vite | RazorPay | API </p>
        ...
        <div className={style.btndivv}>
          {/* <button className={style.btnpro} style={{ backgroundColor: "black" }}>
            <a
              ...
              target="_blank"
              href="https://github.com/ashish-shaw/Nykaa"
            >
              <span>
                <svg
                  style={{
          ...
          {/* <button className={style.btnpro} style={{ backgroundColor: "red" }}>
            <a
              ...
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
              href="https://drive.google.com/file/d/1xpBKC-f6erSCF3ArHYRNPDii6axLywlA/view?usp=sharing"
            >
              <span>
                <img
                  src={youtube}
