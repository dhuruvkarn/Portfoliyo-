  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>
          This Website is for opening in the mWeb for the Wash Subscription
          basically who want monthly , weekly and Daily basis for there car
          wash.
        </p>

        <h3 style={{ color: "#B37D4E" }}>Tech stack:</h3>
        <p>
          React | CSS | JavaScript | Data Structure & Alogrithm | BaseWeb UI
        </p>
        ...
        <div className={style.btndivv}>
          {/* <button className={style.btnpro} style={{ backgroundColor: "black" }}>
            <a
              ...
              target="_blank"
              href="https://github.com/ashish-shaw/Plum"
            >
              <span>
                <svg
                  style={{
          ...
          >
            <a
              ...
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
              href="https://driveu.in/buy-wash-packages/"
            >
              <span>
                <svg
                  style={{
          ...
          {/* <button className={style.btnpro} style={{ backgroundColor: "red" }}>
            <a
              ...
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
              href="https://drive.google.com/file/d/1PJRn1gNltib_R5gBO6gluUs6sTetdAtK/view?usp=sharing"
            >
              <span>
                <img
                  src={youtube}
